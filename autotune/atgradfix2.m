function atgradfix2(bases,dv,side)
...
%opts can be 'short' (to use reduced number of iterations. this is suggested.)
...
for s=1:length(sides) %over sides
    ...
    for i=1:length(gates) 
        ...
        while cont
            ...
            dtrippt=triple-triple0; %format is 1st row dxl dxr, 2nd dyl dyr
...
global tunedata
    ...
    if any(isnan(data{1}(:))); smset(1:19, cell2mat(gtvals)); return; end
